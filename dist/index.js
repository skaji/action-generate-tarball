...
// src/action-generate-tarball.ts
...
var Pr = (s3) => !!s3 && typeof s3 == "object" && (s3 instanceof A || s3 instanceof import_node_stream.default || zr(s3) || Ur(s3));
var zr = (s3) => !!s3 && typeof s3 == "object" && s3 instanceof import_node_events.EventEmitter && typeof s3.pipe == "function" && s3.pipe !== import_node_stream.default.Writable.prototype.pipe;
var Ur = (s3) => !!s3 && typeof s3 == "object" && s3 instanceof import_node_events.EventEmitter && typeof s3.write == "function" && typeof s3.end == "function";
...
var $r = import_fs2.default.writev;
  ...
  [zt]() {
    ...
    try {
      if (!this[J]) {
        this[J] = true;
        do {
          let e = this[Fi](), i = e.length === 0 ? 0 : import_fs2.default.readSync(this[m], e, 0, e.length, null);
...
var { isAbsolute: kn, parse: Ks } = import_node_path4.win32;
var ce = (s3) => {
  let t = "", e = Ks(s3);
  for (; kn(s3) || e.root; ) {
...
var de = class extends A {
  ...
  constructor(t, e = {}) {
    ...
    this.win32 = !!i.win32 || process.platform === "win32", this.win32 && (this.path = Vs(this.path.replaceAll(/\\/g, "/")), t = t.replaceAll(/\\/g, "/")), this.absolute = f(i.absolute || import_path2.default.resolve(this.cwd, t)), this.path === "" && (this.path = "./"), r && this.warn("TAR_ENTRY_INFO", `stripping ${r} from absolute path`, { entry: this, path: r + this.path });
...
var ri = class extends de {
  ...
  [ji]() {
    this[is](import_fs4.default.readlinkSync(this.absolute));
  }
  [ss]() {
    this[rs](import_fs4.default.openSync(this.absolute, "r"));
  }
  [ei]() {
    let t = true;
    try {
...
var os5 = /* @__PURE__ */ Symbol("jobDone");
...
var wt = class extends A {
  ...
  [ir](t) {
    ...
    if (!this.filter(t.path, t)) t.resume();
      ...
      i.entry = new ni(t, this[hs](i)), i.entry.on("end", () => this[os5](i)), this[G] += 1, this[W].push(i);
    }
    this[kt]();
  }
  [li](t) {
  ...
  [sr](t) {
    this[G] += 1;
    try {
      return new this[di](t.path, this[hs](t)).on("end", () => this[os5](t)).on("error", (i) => this.emit("error", i));
    } catch (e) {
      this.emit("error", e);
    }
  }
...
var dr = Kn === "win32";
var { O_CREAT: ur, O_NOFOLLOW: lr, O_TRUNC: mr, O_WRONLY: pr } = import_fs5.default.constants;
var Er = Number(process.env.__FAKE_FS_O_FILENAME__) || import_fs5.default.constants.UV_FS_O_FILEMAP || 0;
var Vn = dr && !!Er;
var $n = 512 * 1024;
var Xn = Er | mr | ur | pr;
var cr = !dr && typeof lr == "number" ? lr | mr | ur | pr : null;
var fs3 = cr !== null ? () => cr : Vn ? (s3) => s3 < $n ? Xn : "w" : () => "w";
var ds = (s3, t, e) => {
  try {
...
var qn = (s3, t, e, i, r) => {
  if (t.isDirectory()) us(import_node_path6.default.resolve(s3, t.name), e, i, (n) => {
    if (n) return r(n);
...
var Qn = (s3, t, e, i) => {
  t.isDirectory() && ms(import_node_path6.default.resolve(s3, t.name), e, i), ds(import_node_path6.default.resolve(s3, t.name), e, i);
};
var ms = (s3, t, e) => {
  let i;
  try {
...
var wr = (s3, t, e) => {
  ...
  let i = t.umask ?? 18, r = t.mode | 448, n = (r & i) !== 0, o = t.uid, h = t.gid, a = typeof o == "number" && typeof h == "number" && (o !== t.processUid || h !== t.processGid), l = t.preserve, c = t.unlink, d = f(t.cwd), S = (E, x) => {
    E ? e(E) : x && a ? us(x, o, h, (Le) => S(Le)) : n ? import_node_fs5.default.chmod(s3, r, e) : e();
  };
...
var ps = (s3, t, e, i, r, n, o) => {
  ...
  import_node_fs5.default.mkdir(a, e, Sr(a, t, e, i, r, n, o));
};
var Sr = (s3, t, e, i, r, n, o) => (h) => {
  h ? import_node_fs5.default.lstat(s3, (a, l) => {
    if (a) a.path = a.path && f(a.path), o(a);
      ...
      if (c) return o(c);
      import_node_fs5.default.mkdir(s3, e, Sr(s3, t, e, i, r, n, o));
    });
    else {
...
var yr = (s3, t) => {
  ...
  let e = t.umask ?? 18, i = t.mode | 448, r = (i & e) !== 0, n = t.uid, o = t.gid, h = typeof n == "number" && typeof o == "number" && (n !== t.processUid || o !== t.processGid), a = t.preserve, l = t.unlink, c = f(t.cwd), d = (E) => {
    E && h && ms(E, n, o), r && import_node_fs5.default.chmodSync(s3, i);
  };
...
var Si = class {
  ...
  #s = /* @__PURE__ */ new Set();
  reserve(t, e) {
    t = io ? ["win32 parallelization disabled"] : t.map((r) => mt((0, import_node_path8.join)(gr(r))));
...
var qt = class extends st {
  ...
  [bs](t, e) {
    let i = typeof t.mode == "number" ? t.mode & 4095 : this.fmode, r = new tt(String(t.absolute), { flags: fs3(t.size), mode: i, autoClose: false });
    r.on("error", (a) => {
...
var xe = class extends qt {
  ...
  [bs](t, e) {
    ...
    try {
      n = import_node_fs3.default.openSync(String(t.absolute), fs3(t.size), i);
    } catch (h) {
      return r(h);
    }
...
// src/action-generate-tarball.ts
var GZIP_LEVEL = 9;
var USTAR_MAX_PATH_BYTES = 256;
var USTAR_MAX_PATH_PART_BYTES = 100;
var USTAR_MAX_PREFIX_BYTES = 155;
var USTAR_MAX_LINKPATH_BYTES = 100;
...
async function run() {
  try {
    ...
    setOutput("tarball", result.output);
  } catch (error2) {
...
function normalizeTopDirectory(input) {
  const normalized = input.trim().replace(/^\/+|\/+$/g, "");
  if (normalized === "" || normalized === "." || normalized === ".." || normalized.includes("/") || normalized.includes("\\") || normalized.split("/").includes("..")) {
...
function compileExcludePatterns(patterns) {
  return patterns.map((pattern) => {
    try {
      ...
      throw new Error(
        `Invalid exclude regular expression ${pattern}: ${error2.message}`
      );
    }
  });
}
async function collectEntries(options) {
  ...
  for (const dirent of dirents.sort((a, b2) => a.name.localeCompare(b2.name))) {
...
function validateUstarEntry(archivePath, options = {}) {
  if (!fitsUstarPath(archivePath)) {
    throw new Error(`Path requires pax extended header: ${archivePath}`);
  }
  if (options.linkpath !== void 0 && Buffer.byteLength(options.linkpath) > USTAR_MAX_LINKPATH_BYTES) {
    throw new Error(`Link path requires pax extended header: ${archivePath}`);
  }
  if (options.size !== void 0 && (options.size < 0 || options.size > USTAR_MAX_FILE_SIZE)) {
    throw new Error(`File size requires pax extended header: ${archivePath}`);
  }
}
function fitsUstarPath(archivePath) {
  ...
  for (let index = 1; index < parts.length; index++) {
    ...
    if (Buffer.byteLength(prefix) <= USTAR_MAX_PREFIX_BYTES && Buffer.byteLength(name) <= USTAR_MAX_PATH_PART_BYTES) {
      return true;
    }
  }
  return false;
}
function shouldExclude(relativePath, exclude, outputRelative) {
  return relativePath === outputRelative || exclude.some((pattern) => pattern.test(relativePath));
}
